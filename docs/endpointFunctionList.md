...
| `cancelWithdrawal()`                    | :closed_lock_with_key: |   DELETE    | `/withdrawals/${params.withdrawal_id}`                             |
...
| `getSubAccount()`                       | :closed_lock_with_key: |     GET     | `/sub_accounts/${params.user_id}`                                  |
| `createSubAccountApiKey()`              | :closed_lock_with_key: |    POST     | `/sub_accounts/${user_id}/keys`                                    |
| `getSubAccountApiKeys()`                | :closed_lock_with_key: |     GET     | `/sub_accounts/${params.user_id}/keys`                             |
| `updateSubAccountApiKey()`              | :closed_lock_with_key: |     PUT     | `/sub_accounts/${user_id}/keys/${key}`                             |
| `deleteSubAccountApiKey()`              | :closed_lock_with_key: |   DELETE    | `/sub_accounts/${params.user_id}/keys/${params.key}`               |
| `getSubAccountApiKey()`                 | :closed_lock_with_key: |     GET     | `/sub_accounts/${params.user_id}/keys/${params.key}`               |
| `lockSubAccount()`                      | :closed_lock_with_key: |    POST     | `/sub_accounts/${params.user_id}/lock`                             |
| `unlockSubAccount()`                    | :closed_lock_with_key: |    POST     | `/sub_accounts/${params.user_id}/unlock`                           |
...
| `getSpotCurrency()`                     |                        |     GET     | `/spot/currencies/${params.currency}`                              |
| `getSpotCurrencyPairs()`                |                        |     GET     | `/spot/currency_pairs`                                             |
| `getSpotCurrencyPair()`                 |                        |     GET     | `/spot/currency_pairs/${params.currency_pair}`                     |
...
| `getPriceTriggeredOrder()`              | :closed_lock_with_key: |     GET     | `/spot/price_orders/${params.order_id}`                            |
| `cancelSpotTriggeredOrder()`            | :closed_lock_with_key: |   DELETE    | `/spot/price_orders/${params.order_id}`                            |
...
| `getCrossMarginCurrency()`              |                        |     GET     | `/margin/cross/currencies/${params.currency}`                      |
...
| `getCrossMarginBorrowLoan()`            | :closed_lock_with_key: |     GET     | `/margin/cross/loans/${params.loan_id}`                            |
...
| `getLendingMarket()`                    |                        |     GET     | `/margin/uni/currency_pairs/${params.currency_pair}`               |
...
| `getFlashSwapOrder()`                   | :closed_lock_with_key: |     GET     | `/flash_swap/orders/${params.order_id}`                            |
...
| `getFuturesContract()`                  |                        |     GET     | `/futures/${params.settle}/contracts/${params.contract}`           |
...
| `getIndexConstituents()`                |                        |     GET     | `/futures/${params.settle}/index_constituents/${params.index}`     |
| `getLiquidationHistory()`               |                        |     GET     | `/futures/${settle}/liq_orders`                                    |
| `getRiskLimitTiers()`                   |                        |     GET     | `/futures/${settle}/risk_limit_tiers`                              |
| `getFuturesAccount()`                   | :closed_lock_with_key: |     GET     | `/futures/${params.settle}/accounts`                               |
...
| `getFuturesPosition()`                  | :closed_lock_with_key: |     GET     | `/futures/${params.settle}/positions/${params.contract}`           |
...
| `getDualModePosition()`                 | :closed_lock_with_key: |     GET     | `/futures/${params.settle}/dual_comp/positions/${params.contract}` |
...
| `getFuturesOrder()`                     | :closed_lock_with_key: |     GET     | `/futures/${params.settle}/orders/${params.order_id}`              |
| `cancelFuturesOrder()`                  | :closed_lock_with_key: |   DELETE    | `/futures/${params.settle}/orders/${params.order_id}`              |
...
| `getFuturesPriceTriggeredOrder()`       | :closed_lock_with_key: |     GET     | `/futures/${params.settle}/price_orders/${params.order_id}`        |
| `cancelFuturesPriceTriggeredOrder()`    | :closed_lock_with_key: |   DELETE    | `/futures/${params.settle}/price_orders/${params.order_id}`        |
| `getAllDeliveryContracts()`             |                        |     GET     | `/delivery/${params.settle}/contracts`                             |
| `getDeliveryContract()`                 |                        |     GET     | `/delivery/${params.settle}/contracts/${params.contract}`          |
...
| `getDeliveryPositions()`                | :closed_lock_with_key: |     GET     | `/delivery/${params.settle}/positions`                             |
| `getDeliveryPosition()`                 | :closed_lock_with_key: |     GET     | `/delivery/${params.settle}/positions/${params.contract}`          |
...
| `getDeliveryOrder()`                    | :closed_lock_with_key: |     GET     | `/delivery/${params.settle}/orders/${params.order_id}`             |
| `cancelDeliveryOrder()`                 | :closed_lock_with_key: |   DELETE    | `/delivery/${params.settle}/orders/${params.order_id}`             |
...
| `getDeliveryTriggeredOrder()`           | :closed_lock_with_key: |     GET     | `/delivery/${params.settle}/price_orders/${params.order_id}`       |
| `cancelTriggeredDeliveryOrder()`        | :closed_lock_with_key: |   DELETE    | `/delivery/${params.settle}/price_orders/${params.order_id}`       |
...
| `getOptionsContract()`                  |                        |     GET     | `/options/contracts/${params.contract}`                            |
...
| `getOptionsUnderlyingTicker()`          |                        |     GET     | `/options/underlying/tickers/${params.underlying}`                 |
...
| `getOptionsPositionContract()`          | :closed_lock_with_key: |     GET     | `/options/positions/${params.contract}`                            |
...
| `getOptionsOrder()`                     | :closed_lock_with_key: |     GET     | `/options/orders/${params.order_id}`                               |
| `cancelOptionsOrder()`                  | :closed_lock_with_key: |   DELETE    | `/options/orders/${params.order_id}`                               |
| `getOptionsPersonalHistory()`           | :closed_lock_with_key: |     GET     | `/options/my_trades`                                               |
| `getLendingCurrencies()`                |                        |     GET     | `/earn/uni/currencies`                                             |
| `getLendingCurrency()`                  |                        |     GET     | `/earn/uni/currencies/${params.currency}`                          |
...
| `getLendingTotalInterest()`             | :closed_lock_with_key: |     GET     | `/earn/uni/interests/${params.currency}`                           |
...
| `getLendingInterestStatus()`            | :closed_lock_with_key: |     GET     | `/earn/uni/interest_status/${params.currency}`                     |
...
| `getLoanOrder()`                        | :closed_lock_with_key: |     GET     | `/loan/collateral/orders/${params.order_id}`                       |
...
| `getMultiLoanOrder()`                   | :closed_lock_with_key: |     GET     | `/loan/multi_collateral/orders/${params.order_id}`                 |
...
| `getStpGroupUsers()`                    | :closed_lock_with_key: |     GET     | `/account/stp_groups/${params.stp_id}/users`                       |
